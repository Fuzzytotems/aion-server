...
// Minimal stand-ins for the core classes that HandlerRegistry.h forward-declares (the real ones come with the spine). Same namespaces and
// names, so the markers and concepts are exercised exactly as handler code will use them. Only this test executable defines them.
