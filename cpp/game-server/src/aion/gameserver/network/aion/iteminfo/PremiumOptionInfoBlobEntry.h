 ...
 * @author Rolandas
 */
class PremiumOptionInfoBlobEntry : public ItemBlobEntry {
	AION_MAKE_REF_FRIEND
protected:
	/** Java: public constructor */
	PremiumOptionInfoBlobEntry();
	~PremiumOptionInfoBlobEntry() override;

public:
	/** Java: new PremiumOptionInfoBlobEntry() */
	static runtime::Ref<PremiumOptionInfoBlobEntry> create();
