...
class GeneratorAwareTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.project = skeleton.Project(cls.root / 'java', None, cls.root / 'cpp', None, skeleton.Fieldmap(), cls.root / 'generated')
...
class DraftRulesTest(unittest.TestCase):
    ...
    def test_nesting_templates_records_interfaces(self):
        ...
        self.assertIn('#include "aion/gameserver/handlers/Unported.h"', controller)
